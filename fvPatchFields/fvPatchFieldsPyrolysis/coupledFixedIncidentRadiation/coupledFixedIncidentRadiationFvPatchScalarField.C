...
#include "coupledFixedIncidentRadiationFvPatchScalarField.H"
...
coupledFixedIncidentRadiationFvPatchScalarField::
coupledFixedIncidentRadiationFvPatchScalarField
(
    const fvPatch& p,
...
coupledFixedIncidentRadiationFvPatchScalarField
(
    const coupledFixedIncidentRadiationFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
coupledFixedIncidentRadiationFvPatchScalarField
(
    const coupledFixedIncidentRadiationFvPatchScalarField&
        wtcsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
tmp<scalarField>
coupledFixedIncidentRadiationFvPatchScalarField::K() const
{
...
void coupledFixedIncidentRadiationFvPatchScalarField::
updateCoeffs()
{
    if (updated())
    {
...
void coupledFixedIncidentRadiationFvPatchScalarField::write
(
    Ostream& os
) const
{

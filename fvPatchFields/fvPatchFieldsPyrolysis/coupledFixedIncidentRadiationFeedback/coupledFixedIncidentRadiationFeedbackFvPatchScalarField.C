...
#include "coupledFixedIncidentRadiationFeedbackFvPatchScalarField.H"
...
coupledFixedIncidentRadiationFeedbackFvPatchScalarField
(
    const coupledFixedIncidentRadiationFeedbackFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
tmp<scalarField>
coupledFixedIncidentRadiationFeedbackFvPatchScalarField::K() const
{
...
void coupledFixedIncidentRadiationFeedbackFvPatchScalarField::
updateCoeffs()
{
    if (updated())
    {
...
*/
        ...
        scalarField gradT_(((QrIncident_+radField)*temissivity-temissivity*sigma_*pow(intFld,4))/K());
...
void coupledFixedIncidentRadiationFeedbackFvPatchScalarField::write
(
    Ostream& os
) const
{
